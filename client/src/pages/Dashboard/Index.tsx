            ...
            <PerfectScrollbar className="relative h-[290px] pr-3 -mr-3 mb-4">
              <div className="text-sm cursor-pointer">
                ...
                <div className="flex items-center py-1.5 relative group">
                  ...
                  <span className="badge badge-outline-warning absolute ltr:right-0 rtl:left-0 text-xs bg-warning-light dark:bg-black opacity-0 group-hover:opacity-100">In progress</span>
                </div>
                <div className="flex items-center py-1.5 relative group">
                ...
                <div className="flex items-center py-1.5 relative group">
                  ...
                  <span className="badge badge-outline-secondary absolute ltr:right-0 rtl:left-0 text-xs bg-secondary-light dark:bg-black opacity-0 group-hover:opacity-100">Pending</span>
                </div>
                <div className="flex items-center py-1.5 relative group">
                  <div className="bg-primary w-1.5 h-1.5 rounded-full ltr:mr-1 rtl:ml-1.5"></div>
                  <div className="flex-1">Updated Server Logs</div>
